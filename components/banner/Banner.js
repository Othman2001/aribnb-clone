...
function Banner () {
  return (
       ...
       <div className="absolute top-1/2 w-full text-center">
           ...
           <button className="text-purble-500 bg-white px-10 py-4 shadow-md rounded-full font-bold my-3 hover:shadow-xl active:scale-90 transition duration-150">Iam Flexable </button>
       </div>
        </div>
  )
}
